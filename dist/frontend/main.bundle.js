...
`, "",{"version":3,"sources":["webpack://./src/frontend/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,iCAAiC;EACjC,aAAa;EACb,gBAAgB;EAChB,qBAAqB;AACvB;;AAEA;EACE,kCAAkC;AACpC","sourcesContent":[".gameItem {\r\n  border: 1px solid #ddd;\r\n  border-radius: 5px;\r\n  box-shadow: 5px 10px 10px #e8f5ee;\r\n  height: 100px;\r\n  overflow: hidden;\r\n  background: #e2e2e2b0;\r\n}\r\n\r\n.unmatched {\r\n  background-color: rgb(232, 79, 79);\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
if (rootElement) {
    gameApp = new _controllers_GameController__WEBPACK_IMPORTED_MODULE_0__.GameController([
        ...
        new _models_GameItem__WEBPACK_IMPORTED_MODULE_1__.GameItem(6, "", "11.png"),
...
class GameController {
    ...
    isWinGame() {
        return (this.items.filter((item) => item.status === _models_GameItem__WEBPACK_IMPORTED_MODULE_2__.GameItemStatus.Open)
        ...
        if (imgElement === null || imgElement === void 0 ? void 0 : imgElement.parentElement) {
            if (isMatched) {
                imgElement.parentElement.className =
                    "col-2 gameItem m-2 p-2 text-center";
            }
            else {
                imgElement.parentElement.className =
                    "col-2 gameItem m-2 p-2  text-center unmatched";
            }
        }
    }
